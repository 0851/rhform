...
function isEmpty(value) {
  ...
  return true;
}const FormStoreContext = /*#__PURE__*/React.createContext({});function defaultValueGetter(e, store, props) {
...
function FormField(props) {
  ...
  if (!store) {
    return /*#__PURE__*/React.createElement(as, newProps, children);
  }
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(as, newProps, children), store.isLoading(name) && loadingAs ? loadingAs : undefined);
...
function _extends() {
  ...
  }, otherProps), !!label && /*#__PURE__*/React.createElement("div", {
  ...
  }, error) : undefined), !!suffix && /*#__PURE__*/React.createElement("div", {
  ...
  return /*#__PURE__*/React.createElement(FormStoreContext.Provider, {
    value: {
      store,
      opts
    }
  }, !as ? /*#__PURE__*/React.createElement(React.Fragment, null, children) : as === 'form' ? /*#__PURE__*/React.createElement('form', {
    className: classNames,
    onSubmit: newOnSubmit,
    onReset: newOnReset,
    ...options
  }, children) : /*#__PURE__*/React.createElement(as, {
    className: classNames,
    ...options
  }, children));
}
...
const FormStore = (_temp = _class = class FormStore {
  ...
  let [store, changeStore] = useState(values); //只在第一次初始化,其他时候不做初始化操作

  let control = useMemo(() => {
    return new FormStore(store, changeStore, rules);
  }, [false]);
  return [control, store, changeStore];
}export{Form,FormField,FormItem,FormStore,FormStoreContext,useFormStore,validator};//# sourceMappingURL=index.js.map
